                                                 ...
                                                 <div class="form-group">
                                                    <form action="{{ route('add.abouta') }}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="text-start mt-2">
                                                            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Add New About Me</button>
                          ...
                          <tbody>
                            ...
                            @foreach ($abouts as $about)
                             <tr>
                                 ...
                                 <td class="col-xl-4 text-break" style="word-wrap: break-word; overflow-wrap: break-word; white-space: normal;">{{ $about->ab_desc }}</td>
                                         ...
                                         <div class="modal fade" id="staticBackdrop-{{ $about->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <form action="{{ route('update.abouta', $about->id) }}" method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                ...
                                                                <div class="text-start mt-2">
                                                                    <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Update Data About</button>
