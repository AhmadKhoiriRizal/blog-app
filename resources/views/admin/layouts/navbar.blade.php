<aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="../dashboard/index.html" class="navbar-brand">
            ...
            <h4 class="logo-title">FahmyBlog</h4>
        </a>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled" href="#" tabindex="-1">
                        <span class="default-icon">ARTICLE BLOG</span>
                        <span class="mini-icon">-</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled" href="#" tabindex="-1">
                        <span class="default-icon">ABOUT ME</span>
                        <span class="mini-icon">-</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled">
                        <span class="default-icon">ADMIN MANAGEMENT</span>
                        <span class="mini-icon">-</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link "  href="/akun">
                        <i class="icon">
                            <svg class="" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
