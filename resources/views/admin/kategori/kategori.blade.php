                      ...
                      <div class="header-title">
                        ...
                        <div class="">
                                 <a href="#" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3" data-bs-toggle="modal" data-bs-target="#staticBackdrop-1">
                                     ...
                                     <span class="fa fa-plus">Add New Category</span>
                                 </a>
                                         ...
                                         <div class="modal-content">
                                             ...
                                             <div class="modal-body">
                                                 <div class="form-group">
                                                    <form action="{{ route('add.categorya') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                            <input type="text" class="form-control mb-2 @error('kategori') is-invalid @enderror" value="{{ old('kategori') }}" id="kategori" name="kategori" placeholder="Input Category Name">
                                                            @error('kategori')
                                                        ...
                                                        <div class="text-start mt-2">
                                                            ...
                                                            <a href="/categorya" type="button" class="btn btn-danger">Cancel</a>
                                                        </div>
                                                    </form>
                                             </div>
                                         </div>
                       ...
                       <table id="add-row" class="table table-bordered" data-toggle="data-table">
                          <thead class="table-info">
                             <tr>
                                 ...
                                 <th class="col-xl-9 text-center">CATEGORY</th>
                                 <th class="col-xl-2 text-center">ACTION</th>
                             </tr>
                          </thead>
                          <tbody>
                            @php
                            ...
                            @foreach ($categorys as $category)
                             <tr>
                                 ...
                                 <td class="col-xl-9 text-break">{{ $category->kategori }}</td>
                                 <td class="col-xl-2 text-center">
                                     <div style="display: flex; align-items: center; justify-content:space-evenly">
                                         <a class="btn btn-sm btn-icon text-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop-{{ $category->id }}" title="Edit User" href="">
                                         ...
                                         <div class="modal fade" id="staticBackdrop-{{ $category->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <form action="{{ route('update.categorya', $category->id) }}" method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                    <input type="text" class="form-control mb-2 @error('kategori') is-invalid @enderror" value="{{ old('kategori', $category->kategori) }}" id="kategori" name="kategori" placeholder="Input Category Name">
                                                                    @error('kategori')
                                                                    <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                    </div>
                                         ...
                                         <form action="{{ route('destroy.categorya', $category->id) }}" method="POST" onsubmit="return confirm('Apakah yakin akan dihapus?')">
                                            @csrf
