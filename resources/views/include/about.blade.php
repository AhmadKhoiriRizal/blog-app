                ...
                <div class="row mb-5">
                    <div class="d-md-flex post-entry-2 half">
                        <a href="#" class="me-4 thumbnail">
                            <img src="{{ asset('storage/about/'. $about->ab_foto) }}" alt="" class="img-fluid" >
                        </a>
                        <div class="ps-md-5 mt-4 mt-md-0">
                            <div class="post-meta mt-4">{{ $about->ab_judul }}</div>
                            <h2 class="mb-4 display-4">{{ $about->ab_tag }}</h2>
                            <p style="text-justify: inter-word;">{{ $about->ab_desc }}</p>
                        </div>
                    </div>
                </div>
            @else
